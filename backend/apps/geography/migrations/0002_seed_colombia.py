...
COLOMBIA_DATA = {
    ...
    "Sucre": ["Sincelejo", "Buenavista", "Caimito", "Chalán", "Coloso", "Corozal", "Coveñas", "El Roble", "Galeras", "Guaranda", "La Unión", "Los Palmitos", "Majagual", "Morroa", "Ovejas", "Palmito", "Sampués", "San Benito Abad", "San Juan de Betulia", "San Luis de Sincé", "San Marcos", "San Onofre", "San Pedro", "Santiago de Tolú", "Sucre", "Tolú Viejo"],
...
def seed_geography(apps, schema_editor):
    ...
    colombia = Country.objects.create(name="Colombia", iso_code="COL", phone_code="+57", is_active=True)

    for state_name, cities in COLOMBIA_DATA.items():
        state = State.objects.create(country=colombia, name=state_name, is_active=True)
        City.objects.bulk_create([
            City(state=state, country=colombia, name=city_name, is_active=True)
            for city_name in cities
        ])

    for name, iso, phone in OTHER_COUNTRIES:
        Country.objects.create(name=name, iso_code=iso, phone_code=phone, is_active=True)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(seed_geography, reverse_seed),
    ]
