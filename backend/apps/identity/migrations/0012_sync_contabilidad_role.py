...
NEW_ROLE_CODES = ("CONTABILIDAD",)


def sync_contabilidad_role(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("identity", "0011_user_can_view_loan_requests"),
    ]

    operations = [
        migrations.RunPython(sync_contabilidad_role, noop),
    ]
