...
def _draw_footer(c, page_w, page_number):
    _text(
        ...
        32,
        24,
        "Documento generado para control interno de Recursos Humanos.",
        size=6.8,
        color=MUTED,
    )
